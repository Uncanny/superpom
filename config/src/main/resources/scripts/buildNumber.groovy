...
buildNumberString="${tag} build ${commitsCount} (${branch}@${revision})"
project.properties.setProperty('uncanny.buildNumber',buildNumberString)
println "Build number: " + buildNumberString